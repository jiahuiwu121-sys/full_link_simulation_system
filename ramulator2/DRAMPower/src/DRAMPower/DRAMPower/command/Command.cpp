...
namespace DRAMPower {
    ...
    TargetCoordinate::TargetCoordinate(std::size_t bank_id, std::size_t bank_group_id, std::size_t rank_id,
                                       std::size_t row_id, std::size_t column_id, std::size_t pseudo_channel_id,
                                       std::size_t sid_id, std::size_t channel_id)
        : bank(bank_id), bankGroup(bank_group_id), rank(rank_id), row(row_id), column(column_id)
        , pseudoChannel(pseudo_channel_id), sid(sid_id), channel(channel_id)
    {};
