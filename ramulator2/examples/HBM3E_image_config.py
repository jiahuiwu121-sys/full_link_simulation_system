...
def make_dram():
    ...
    # Ramulator2 models HBM3E through its HBM3 command/state implementation.
...
POWER_MODEL = HBM34PowerModel(
    make_dram(), ROOT / "examples/power_specs/HBM3E_image_config.generated.json"
)
